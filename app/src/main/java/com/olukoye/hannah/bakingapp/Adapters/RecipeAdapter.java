...
public class RecipeAdapter extends RecyclerView.Adapter<RecipeAdapter.RecyclerViewHolder>
{
    ...
    ArrayList<RecipeObjects> lRecipes;
    Context mContext;
    final private ListItemClickListener lOnClickListener;

    public interface ListItemClickListener {
        void onListItemClick(RecipeObjects clickedItemIndex);
    }
    ...
    public void setRecipeData(ArrayList<RecipeObjects> recipesIn, Context context) {
        lRecipes = recipesIn;
        mContext=context;
