...
package com.olukoye.hannah.bakingapp.Adapters;
...
import com.olukoye.hannah.bakingapp.Pojos.StepsObject;
...
public class RecipeDetailAdapter extends RecyclerView.Adapter<RecipeDetailAdapter.RecyclerViewHolder> {
    ...
    List<StepsObject> lSteps;
    private String recipeName;

    final private ListItemClickListener lOnClickListener;

    public interface ListItemClickListener {
        void onListItemClick(List<StepsObject> stepsOut, int clickedItemIndex, String recipeName);
    }
    ...
    public void setMasterRecipeData(List<RecipeObjects> recipesIn, Context context) {
        //lSteps = recipesIn;
