...
public class RecipeDetailActivity extends AppCompatActivity implements RecipeDetailAdapter.ListItemClickListener,RecipeStepDetailFragment.ListItemClickListener{
    ...
    private ArrayList<RecipeObjects> recipe;
    String recipeName;
    ...
    @Override
    public void onListItemClick(List<StepsObject> stepsOut, int selectedItemIndex, String recipeName) {
        ...
        stepBundle.putParcelableArrayList(SELECTED_STEPS,(ArrayList<StepsObject>) stepsOut);
